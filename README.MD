...
2. Translate all GUI and code notes to English
3. Support controling media
4. Support calls
5. ~~Improve UI~~ DONE! V0.1
6. Support SMS (Need phone that supported MAP)
7. Fix VCF parser (UI00)
